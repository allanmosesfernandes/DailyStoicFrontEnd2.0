...
const HomePage = () => {
    ...
    return (
        <>
            <div className="d-flex flex-column align-items-center justify-center text-center mt-2">
                <h1 className="font-gothic text-4xl lg:text-6xl border-t-2 border-slate-400 border-b-2 lg:mb-10 p-4">
                ...
                <p className="lg:text-xl sm:text-xl text-md font-playfair lg:w-9/12 w-11/12 mx-auto lg:my-10 my-6">
                    <span className="">
                        <a
                            href="https://en.wikipedia.org/wiki/Memento_mori"
                            target="_blank"
                            className="underline font-gothic"
                        >
                            Memento Mori:
                        </a>
                    </span>{' '}
                ...
                <p className="lg:text-xl sm:text-xl text-md  font-playfair lg:w-9/12 w-11/12 mx-auto lg:my-10 my-6 leading-loose">
                    ...
                    <span className="text-">({daysInMonthRemainingPercentage}%)</span> already gone
                    in {monthName}.
                </p>
            </div>
            <DailyQuote />
