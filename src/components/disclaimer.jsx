            ...
            <div className="d-flex flex-column align-items-center justify-center text-center lg:my-20 mb-8">
                ...
                <div className="leading-relaxed pb-20">
                    <p className="lg:text-2xl sm:text-xl text-md font-playfair lg:w-9/12 w-11/12 m-auto leading-10">
                        ...
                        <a
                            href="https://ryanholiday.net/ryan-holiday-books/"
                            target="_blank"
                            className="underline"
                        >
                            The Daily Stoic{' '}
                        </a>
                        by Ryan Holiday. <br /> We do not own any of the content on this section and
                        intend no copyright infringement. <br />
                        Our website is simply a tool to spread the teachings of stoicism.
                    </p>
                </div>
            </div>
        </>
